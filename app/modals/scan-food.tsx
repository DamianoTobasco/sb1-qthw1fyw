...
// NOTE: In a production app, this key should be stored securely in environment variables
// and accessed through a backend service, never exposed in the client code
const openai = new OpenAI({
  apiKey: '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',
...
export default function ScanFoodModal() {
  ...
  // Analyze image using OpenAI's GPT-4o
